...
__published:	// IDE-managed Components
	...
	TLabeledEdit *TubeZedit;
	TLabeledEdit *RaftNumEdit;
	...
	void __fastcall TubeZeditExit(TObject *Sender);
	void __fastcall TubeZeditKeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
	void __fastcall RaftNumEditExit(TObject *Sender);
	void __fastcall RaftNumEditKeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
