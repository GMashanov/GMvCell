...
//-------------------------------------------------------------
 ...
 typedef struct { // cell properties
				  bool nucleus,tubeNetwork,grid,rafts,nucleusProt,filopodia,lamella;
				  bool tubes,roundedCellBody,movingVesicles,outsideVesicles;
				  bool makePore,mitochondria,tube3D,recycling,fuseVes,bool10;
				  ...
				  double Kobj,velocity,bendTilt,vesicleMob,cellD3,cellD4,cellD5,cellD6;
				  /// illumination and imaging
				  bool cancel,EMCCD,alterIllum,twoCam;
				  int gain,illuminationFWHM,fenceJumpProb,irisRadiusNm,FWHM,nm_pix;
				  ...
				  // memb A prop
				  bool membApolimer,membAcanBindMembB,oneColourAA,membAnuclTubePump;
				  ...
				  double membAAbindRate,membAAdissRate,rDmembA1,rDmembA2,rDmembA3;
				  // memb B prop
				  ...
				  int greenStatAnum,greenStatAfraction,redStatAnum,redStatAfraction;
				 ...
				 // reserve
				  ...
				  double greenBlinkONrate,greenBlinkOFFrate,FRETratePercent,resD4,resD5,resD6,resD7,resD8,resD9;
				} COND;
...
//-------------------------------------------
 ...
 // Cell properties
 bool grid,rafts,tubeNetwork,filopodia,nucleusProt,transfer;
 bool nucleus,lamella,tubes,movingVesicle,roundedCellBody,movingVes,fuseVesicles;
 bool outsideVes,makePore,mitochondria,tube3D,recycling;
 ...
 int interTubeDistNm,vesRadNm,bodyFilletNm,vesNum;
 int tubeLengthNm,matrixXnm,matrixYnm,matrixZnm,tubeGapNm,poreRadNm,poreRadVox;
 int tubeGapVox,tubeRadVox,tubeZminVox,tubeZmaxVox,tubeNum;
 double velocity,flattening,nucleusRadNm,bendTilt,vesicleMob;
 double fissionCoef,tX,tY,tZ,tAzi,tEle;
 // Illumination and Imaging prop

 bool EMCCDmode,bleachSquare,bleachSpot,bleachStrip,twoCam,alterIllum,FRETon;
 ...
 int x_num,x_shift,numOFsites,nm_pix,cycleNum,frameCount,intVar;
 int focusPos,raftRadNm,gridSizeNm,bleachSize;
 ...
 double raftMobRatio,irisRadiusNm,IDum,IAum2,IVum3,Kobj;
 double d488,d561,FWHM,illuminationFWHM,noiseAmp,TIRangle;
 ...
 double membAmob,membAAbindRate,membAAdissRate;
 ...
 int greenStatAfraction,greenStatAnum,redStatAfraction,redStatAnum;
 // Statistic
 ...
 int cytoBboundToStatAnum,cytoAboundToCytoBnum,cytoAinNucleus,vesiGen;
